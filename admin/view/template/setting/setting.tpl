          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="config_google" value="<?php echo $config_google; ?>" placeholder="Социальные сети (Google+)" id="input-google" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-in">Социальные сети (In)</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_in" value="<?php echo $config_in; ?>" placeholder="Социальные сети (In)" id="input-in" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-vk">Социальные сети (VK)</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_vk" value="<?php echo $config_vk; ?>" placeholder="Социальные сети (VK)" id="input-vk" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-fb">Социальные сети (FB)</label>
                  <div class="col-sm-10">
                    <input type="text" name="config_fb" value="<?php echo $config_fb; ?>" placeholder="Социальные сети (FB)" id="input-fb" class="form-control" />
                  </div>
                </div>
                <div class="form-group">
